...
export default function App({ Component, pageProps }) {
  return (
    <div id="app">
      ...
      <header>
        <nav className="fixed top-0 inset-x-0 flex justify-between p-4 select-none hidden md:block">
          <div className="flex items-center gap-2">
            <Image src="/dizzy.png" width={40} height={40} />
            <span className="font-bold text-xl">怪奇灵感生成器</span>
          </div>
        </nav>

        <a href="https://github.com/BigCoke233/bizzare-inspirer" rel="noreferrer" target="_blank" className="github-corner" aria-label="View source on GitHub"><svg width="80" height="80" viewBox="0 0 250 250" 
      ...
      <Component {...pageProps} />
      <footer className="fixed inset-x-0 bottom-0 text-gray-400 text-sm p-4 z-0
